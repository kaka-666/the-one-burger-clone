...
export const SPEC_BLOCKS = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Full The One prep (from order)', value: '5–8min.', forceScroll: true },
  ...
  },
  {
    ...
    items: [
      { name: 'From prep, we recommend eating within:', value: '<30min', forceScroll: true },
...
export const FAQS = [
  {
    ...
    answer:
      'The One is the burger you were looking for. We have also been at the dilemma of having to choose what we eat today, whether at home or during work breaks. For those who seek simplicity, the choice is simply The One.',
  },
  {
    ...
    answer: [
      ...
      '*As you know, delivery companies apply certain fees that we are not responsible for and have no control over; The One home delivery may cost approximately the listed price of €9.99. We strive to constantly review these prices so that our customers receive fair pricing.',
    ],
    answerBreak: 'double',
  },
  {
    ...
    answer:
      "9.99€ With fries, sauces and drink. 9.99€ Even if you don't want the fries, sauce or drink.",
  },
  {
    question: 'What happens if I want to modify The One?',
    answer:
      'You can choose between The One: Beef, Chicken, and Veggie. Among these three varieties, we allow you to remove ingredients, but you cannot exclude either fries or the drink.',
  },
  {
    question: "And if I still don't want the fries and/or drink?",
    answer:
      'Share it with your coworker, give it to someone, or save it for later. The One is a unique menu: burger, fries, sauces and drink.',
  },
  {
    question: 'Why can I only change the patty at The One?',
    answer:
  ...
  },
  {
    ...
    answer: 'We have a variety of soft drinks, water, beer, and iced tea.',
  },
  {
    question: "But look, what happens if I still don't want the fries and/or drink?",
    answer: 'The One comes with burger, fries and drink.',
  },
  {
  ...
  {
    question: 'Questions, feedback, or suggestions?',
    answer:
